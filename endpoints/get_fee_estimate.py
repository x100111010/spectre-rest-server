...
@app.get("/info/fee-estimate", response_model=FeeEstimateResponse, tags=["Spectre network info"])
async def get_fee_estimate():
    ...
    if resp is None:
        raise HTTPException(status_code=501, detail="Spectred does not support fee estimate")
