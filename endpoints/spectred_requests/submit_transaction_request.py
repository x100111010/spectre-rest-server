...
async def submit_a_new_transaction(
    ...
    if replaceByFee:
        ...
        tx_resp = await spectred_client.request("submitTransactionReplacementRequest", params=body.dict())
        tx_resp = tx_resp["submitTransactionReplacementResponse"]
    else:
        tx_resp = await spectred_client.request("submitTransactionRequest", params=body.dict())
